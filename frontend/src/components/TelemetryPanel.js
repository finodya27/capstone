...
// HAPUS: import useTelemetry from "../hooks/useTelemetry"; 
// Ganti dengan menerima props

// ✅ GANTI DENGAN MENERIMA PROPS DARI DASHBOARD
const TelemetryPanel = ({ telemetryData }) => {
    // Gunakan telemetryData yang diterima dari Dashboard.js

    // ✅ JIKA DATA NULL, TAMPILKAN PLACEHOLDER SEDERHANA
    if (!telemetryData) {
        return (
            <div className="bg-white p-6 rounded-lg shadow-xl h-full flex flex-col items-center justify-center">
                ...
                <p className="text-gray-500 mt-4 text-center">Menunggu data telemetri...</p>
                <p className="text-xs text-gray-400 mt-1">Menggunakan data fallback Firebase.</p>
            </div>
        );
    }
    ...
    // Ganti div paling luar menjadi card utama
    return (
        <div className="bg-white p-6 rounded-lg shadow-xl h-full flex flex-col">
            <h2 className="text-xl font-semibold mb-4 text-blue-800 border-b pb-2">Status Telemetry</h2>
